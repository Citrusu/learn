    ...
    + function($) {
        ...
        var Picker = function (params) {
            ...
            var defaults = {
                ...
                toolbar: true,
                toolbarCloseText: '确定',
                toolbarTemplate: '<header class="ui-bar ui-bar-nav">\
                <button class="ui-button ui-button-link ui-pull-right ui-close-picker">确定</button>\
                <h1 class="ui-title">请选择</h1>\
                </header>',
            };
            params = params || {};
            ...
            p.initPickerCol = function (colElement, updateItems) {
                ...
                col.wrapper = col.container.find('.ui-picker-items-col-wrapper');
                col.items = col.wrapper.find('.ui-picker-item');
                ...
                col.calcSize = function () {
                    if (p.params.rotateEffect) {
                        col.container.removeClass('ui-picker-items-col-absolute');
                    ...
                    if (p.params.rotateEffect) {
                        ...
                        col.container.addClass('ui-picker-items-col-absolute');
                    }
                };
                col.calcSize();
                ...
                col.setValue = function (newValue, transition, valueCallbacks) {
                    ...
                    var newActiveIndex = col.wrapper.find('.ui-picker-item[data-picker-value="' + newValue + '"]').index();
                ...
                col.updateItems = function (activeIndex, translate, transition, valueCallbacks) {
                    ...
                    col.wrapper.find('.ui-picker-selected').removeClass('ui-picker-selected');
                    if (p.params.rotateEffect) {
                        col.items.transition(transition);
                    }
                    var selectedItem = col.items.eq(activeIndex).addClass('ui-picker-selected').transform('');
                    ...
                    col.items.each(function () {
                        ...
                        if (angle < -180) angle = -180;
                        // Far class
                        if (Math.abs(percentage) > itemsFit) item.addClass('ui-picker-item-far');
                        else item.removeClass('ui-picker-item-far');
                        // Set transform
            ...
            p.columnHTML = function (col, onlyItems) {
                ...
                var columnHTML = '';
                if (col.divider) {
                    columnHTML += '<div class="ui-picker-items-col ui-picker-items-col-divider ' + (col.textAlign ? 'ui-picker-items-col-' + col.textAlign : '') + ' ' + (col.cssClass || '') + '">' + col.content + '</div>';
                }
                else {
                    for (var j = 0; j < col.values.length; j++) {
                        columnItemsHTML += '<div class="ui-picker-item" data-picker-value="' + col.values[j] + '">' + (col.displayValues ? col.displayValues[j] : col.values[j]) + '</div>';
                    }

                    columnHTML += '<div class="ui-picker-items-col ' + (col.textAlign ? 'ui-picker-items-col-' + col.textAlign : '') + ' ' + (col.cssClass || '') + '"><div class="ui-picker-items-col-wrapper">' + columnItemsHTML + '</div></div>';
                }
            ...
            p.layout = function () {
                ...
                pickerClass = 'ui-picker-modal ui-picker-columns ' + (p.params.cssClass || '') + (p.params.rotateEffect ? ' picker-3d' : '');
                pickerHTML =
                    '<div class="' + (pickerClass) + '">' +
                    (p.params.toolbar ? p.params.toolbarTemplate.replace(/{{closeText}}/g, p.params.toolbarCloseText) : '') +
                    '<div class="ui-picker-modal-inner ui-picker-items">' +
                    colsHTML +
            ...
            function onPickerClose() {
                ...
                // Destroy events
                p.container.find('.ui-picker-items-col').each(function () {
        ...
        $(document).on("click", ".ui-close-picker", function() {
            var pickerToClose = $('.ui-picker-modal.ui-modal-in');
